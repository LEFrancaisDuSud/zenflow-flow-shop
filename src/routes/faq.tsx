...
const faqs = [
  { q: "Combien de temps prend la livraison ?", a: "Vos commandes sont expédiées sous 24h ouvrées et livrées sous 48-72h en France métropolitaine via Colissimo ou Mondial Relay." },
